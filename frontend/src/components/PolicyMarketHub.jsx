      ...
      {!hideHeader ? (
        <CardHeader className="pb-3">
          <div className="flex items-start justify-between gap-4">
            <div>
              <CardTitle className="text-xl">{t("Policy & Market Hub")}</CardTitle>
              <p className="mt-1 text-sm text-muted-foreground">
                {t("Growth curves, insurance needs, and tax-aware education for Indian investors.")}
              </p>
            </div>
          </div>
        </CardHeader>
              ...
              <div className="lg:col-span-5">
                <div className="glass-strong rounded-2xl p-5 space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs text-muted-foreground">{t("Expected return (p.a.)")}</Label>
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs text-muted-foreground">{t("Inflation")}</Label>
              ...
              <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-12">
                <div className="lg:col-span-7">
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="space-y-2">
                      <Label className="text-xs text-muted-foreground">{t("Monthly savings")}</Label>
                  ...
                  <div className="mt-4 flex items-center gap-3">
                    <Button onClick={runInsuranceAnalysis} disabled={insuranceLoading}>
                      {insuranceLoading ? t("Analyzing...") : t("Run analysis")}
                    </Button>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
              <div className="lg:col-span-7">
                <div className="glass rounded-2xl p-5">
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead>{t("What to watch")}</TableHead>
                        </TableRow>
                      </TableHeader>
                  ...
                  <p className="text-sm font-semibold text-foreground">{t("How to use this in planning")}</p>
                  <p className="mt-1 text-sm text-muted-foreground">{t("Compare returns across SIP/FD/RD using post-tax assumptions, and choose deductions (old tax regime) that match your horizon and liquidity needs.")}</p>
                </div>
              </div>
                    ...
                    <div className="glass rounded-2xl p-4">
                      ...
                      <div className="mt-3 overflow-hidden">
                        <Table>
                          <TableBody>
                            <TableRow>
                              <TableCell className="font-medium">{t("Feature")}</TableCell>
                              <TableCell>{t("SIP")}</TableCell>
                              <TableCell>{t("RD")}</TableCell>
                              <TableCell>{t("FD")}</TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell className="font-medium">{t("Investment type")}</TableCell>
                              <TableCell>{t("Market-linked")}</TableCell>
                              <TableCell>{t("Bank deposit")}</TableCell>
                              <TableCell>{t("Bank deposit")}</TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell className="font-medium">{t("Risk")}</TableCell>
                              <TableCell>{t("Medium-High")}</TableCell>
                              <TableCell>{t("Low")}</TableCell>
                              <TableCell>{t("Very Low")}</TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell className="font-medium">{t("Returns")}</TableCell>
                              <TableCell>{t("Highest (long term)")}</TableCell>
                              <TableCell>{t("Medium")}</TableCell>
                              <TableCell>{t("Low")}</TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell className="font-medium">{t("Compounding")}</TableCell>
                              <TableCell>{t("Yes (strong)")}</TableCell>
                              <TableCell>{t("Limited")}</TableCell>
                              <TableCell>{t("Limited")}</TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell className="font-medium">{t("Best for")}</TableCell>
                              <TableCell>{t("Long-term goals")}</TableCell>
                              <TableCell>{t("Short-term savings")}</TableCell>
                              <TableCell>{t("Capital protection")}</TableCell>
                            </TableRow>
                          </TableBody>
                        </Table>
                      </div>
                      <div className="mt-3 text-sm text-muted-foreground">
                        <p className="font-medium mb-2">{t("Key Points:")}</p>
                        <ul className="list-disc pl-5 space-y-1">
                          <li>{t("FD > RD in returns if interest rate is the same and total invested amount is the same")}</li>
                          <li>{t("RD is better if you don't have a lump sum amount to invest")}</li>
                        </ul>
                      </div>
                    </div>
